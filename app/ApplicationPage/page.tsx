      ...
      <div className="bg-white border-b-2 border-black p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="text-2xl font-bold">VLSystem</div>
          </div>
          <div className="text-xl font-semibold">Navigation Bar</div>
          <div className="flex gap-4">
            <button className="px-4 py-2 border border-gray-300 rounded">English</button>
            <button className="px-4 py-2 border border-gray-300 rounded">Loan Simulator</button>
            <button className="px-4 py-2 border border-gray-300 rounded">Team</button>
            <button className="px-4 py-2 border border-gray-300 rounded">About Us</button>
            <button className="px-4 py-2 border border-gray-300 rounded">Contact Us</button>
            <button className="px-4 py-2 bg-red-600 text-white rounded">Login</button>
          </div>
        </div>
      </div>
