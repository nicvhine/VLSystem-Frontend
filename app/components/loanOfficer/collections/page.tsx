...
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
  ...
  {/* Collection Progress */}
  <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white flex flex-col justify-between col-span-1">
  ...
  {/* Amount Collected */}
  <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white flex flex-col justify-between col-span-1">
    <div className="flex items-center gap-3 mb-4">
