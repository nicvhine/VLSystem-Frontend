...
export default function LoansPage() {
  ...
  const computeProgress = (loan: LoanDetails) => {
    if (!loan.totalPayable) return 0;
    return Math.round(((loan.totalPayable - loan.balance) / loan.totalPayable) * 100);
  };
        ...
        <div className="mx-auto px-6 py-8">
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="divide-y divide-gray-200">
                  {sortedLoans.map((loan) => {
                    const progress = computeProgress(loan);
                    ...
                    return (
                      ...
                      >
                        <td className="px-6 py-4 text-sm text-gray-900">
                          <Link href={`/components/loanOfficer/loans/${loan.loanId}`}>
                            {loan.loanId}
                          </Link>
                        </td>
          ...
          <div className="flex items-center justify-between mt-6">
            ...
            <div className="flex gap-2">
              ...
              <button className="px-4 py-2 border border-gray-200 rounded-lg text-gray-600 hover:bg-gray-50 transition-all">
                Next
              </button>
            </div>
          </div>
