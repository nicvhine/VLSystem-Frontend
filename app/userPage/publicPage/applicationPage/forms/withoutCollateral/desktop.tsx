...
const API_URL = "http://localhost:3001/loan-applications/apply/without";
...
<div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6 mb-6">
  ...
  <div className="grid grid-cols-2 gap-4">
    ...
    <div>
      ...
      <input
        type="number"
        className={`w-full border p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent ${selectedLoan === null && customLoanAmount !== '' ? 'border-red-500' : 'border-gray-200'}`}
        ...
        placeholder={
          language === "en"
            ? "Enter amount (₱10,000 - ₱30,000)"
            : "Isulod ang kantidad (₱10,000 - ₱30,000)"
        }
      />
      {selectedLoan === null && customLoanAmount !== "" && (
        <p className="text-sm text-red-500 mt-1">
          {language === "en"
            ? "Amount not within allowed range. Please enter between ₱10,000 - ₱30,000."
            : "Ang kantidad kinahanglan tali sa ₱10,000 - ₱30,000."}
        </p>
      )}
    </div>
  ...
  {customLoanAmount && selectedLoan && (
    <div className="mt-6 border-t pt-4 text-gray-100">
      ...
      {(() => {
        ...
        const serviceChargeRate = 0.05; // 5% deduction
