...
export default function Sysad({ children, isNavbarBlurred = false }: { children?: React.ReactNode; isNavbarBlurred?: boolean }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Navbar role="sysad" isBlurred={isNavbarBlurred} />
