'use client';
  ...
  import WithCollateral from './components/withCollateralType';
  import OpenTerm from './components/openTermType';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <Link href="/components/manager/applications" className="text-gray-400 hover:text-gray-600">
